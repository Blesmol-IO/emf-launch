...
public class TestVogellaStackFrame extends TestDebugElement implements IStackFrame {

	private IThread thread;
	private int charPos;
	private String wordToBeSpelled;

	public TestVogellaStackFrame(IThread thread, String wordToBeSpelled, int charPos) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TestVogellaStackFrame other = (TestVogellaStackFrame) obj;
